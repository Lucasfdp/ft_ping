...
///
/// Wording follows libping.c in the reference. stderr, and unconditional:
/// this is a fault in the network rather than a ping result, and it is the
/// explanation for loss that would otherwise look inexplicable.
///
