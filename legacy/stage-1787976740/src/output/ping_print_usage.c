...
void	print_usage(void)
{
	...
	printf("  --bsd-flood    with -f, also send a packet on every reply.\n");
	printf("                 Off by default: inetutils-2.0 paces flood by\n");
	printf("                 its 10ms timer alone, and that is the\n");
	printf("                 behaviour this program matches. Turn this on\n");
	printf("                 for the BSD/macOS behaviour, where the rate is\n");
	printf("                 bound by the round-trip time instead.\n\n");
